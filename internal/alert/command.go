...
// ParseCommand understands /start, /help, /minsize [amount], /net [Nh|trader], /pos [market], /port [trader], /lasttrades [trader] [market] [Nh], /tracked, /add, /unadd, /kelly, /ob, and /update.
